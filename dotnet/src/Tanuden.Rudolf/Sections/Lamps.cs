...
///   (blinking, dim, multicolor). Basic HMI that only knows 0/1 SHOULD treat any nonzero as truthy.
///   Default keys include <c>doorClose</c>, <c>atsReady</c>, <c>atsBrakeApply</c>, <c>atsOpen</c>,
///   <c>regenerative</c>, <c>ebTimer</c>, <c>emergencyBrake</c>, <c>overload</c>, <c>ato</c>,
///   <c>snowBrake</c>, <c>wheelSlip</c>.
