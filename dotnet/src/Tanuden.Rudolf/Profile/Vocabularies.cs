...
public class Vocabularies
{
  ...
  [JsonIgnore]
  public static readonly Dictionary<string, int> DefaultLamps = new Dictionary<string, int>
  {
    { "doorClose", 0 },
    { "atsReady", 1 },
    { "atsBrakeApply", 2 },
  ...
  [JsonIgnore]
  public static readonly Dictionary<string, string> DefaultSignalPhase = new Dictionary<string, string>
  {
    { "0", ":" },
    { "1", "R" },
    { "2", "YY" },
  ...
  [JsonIgnore]
  public static readonly Dictionary<string, double?> DefaultSignalPhaseSpeed = new Dictionary<string, double?>
  {
    { "0", -1 },
    { "1", 0 },
    { "2", 25 },
